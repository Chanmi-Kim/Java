...
public class Ex58_Casting {
	...
	public static void main(String[] args) {
		...
		// - *** 개발자측에서는 객체의 타입이 중요한게 아니라 참조 변수의 타입이 중요하다. > 참조 변수의 모든 멤버가 실존해야 하고 정상 동작해야 한다.
		// - 부모클래스 -> 자식 클래스 : 다운 캐스팅(Down Casting) - 명시적 형변환
		// - 자식클래스 -> 부모 클래스 : 업 캐스팅(Up Casting) - 암시적 형변환
