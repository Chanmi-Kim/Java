...
public class Ex83_Collection {
	...
	public static void main(String[] args) {
		...
		- 사용 용도는 거의 유사하다.
		- 길이가 가변인 스칼라 배열이 필요할 때 사용한다.(순차적인 방번호를 가지는 집합 필요)
		
		ArrayList
		- 장점 : 모든 컬렉션 중 요소에 대한 접근 속도가 가장 빠르다.(읽기 장점)
		- 단점 : 요소의 추가/삭제 작업 비용 발생(느리다.)
		
		LinkedList
		- 장점 : 요소의 추가/삭제 작업 비용 저렴(빠르다.)
		- 단점 : 접근 속도가 아주 느리다.(읽기 느림)
		...
		*/
		...
		System.out.println("중간에 데이터 삭제. Delete > Shift");
