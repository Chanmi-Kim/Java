...
public class Ex47_Constructor {
	...
	public static void main(String[] args) {
		...
		//Ex47_Constructor.java
		
		int[] ns = new int[3];//모든 방이 0으로.. > 참조형 > 생성자 때문에..
		...
		Member m2 = new Member("아무개", "aaa", "1", "반갑습니다.");
		...
		System.out.println(StaticTest.getB());//공용데이터 초기화를 왜 s1에게 맡겨??
...
//	public Member(String level, String info) {
//		
//	}
