...
public class Ex34_Class {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//모니터 크기
		//s1 : 객체, 인스턴스, 변수, 객체 변수, 인스턴스 변수, 참조 변수, Size 변수
		Size s1 = new Size();
...
//		m1.substract(100, 50);
		...
		MyMath.add(30, 40);
		MyMath.substract(100, 30); //static 키워드
...
class SmartPhone {
	...
	//멤버 메소드 : 항상 객체의 메소드는 자신은 정보를 바탕으로 행동한다.(***********)
	public void call() {
