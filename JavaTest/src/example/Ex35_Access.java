...
//		hong.name = "홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하홍길동안녕하세요하하하";
//		hong.id = "hong";
//		hong.age = 200000000;
//
...
//		System.out.println(hong.age);
		...
		hong.aaa("홍길동"); //private String name에게 전달
		hong.setId("hong");
		hong.setAge(2000000000);
		...
		//읽기 전용 프로퍼티
		System.out.println(keyboard.getKeys()); //108
		//keyboard.setKeys(88);
...
class Member {
	...
	//고민? public or private
	//****** 무조건(되도록) 멤버 변수는 private으로 선언한다.
//	public String name;
//	public String id;
//	public int age;
...
class Keyboard {
	...
	public void setType(String type) {
		if (type.equals("기계식") || type.equals("멤브레인") 
								|| type.equals("펜타그래프")) {
			this.type = type;
		} else {
			System.out.println("취급하지 않는 타입니다.");
		}
	}
